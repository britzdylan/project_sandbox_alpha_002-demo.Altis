...
_x addPrimaryWeaponItem "30Rnd_556x45_Stanag";
...
for "_i" from 1 to 2 do {_x addItemToVest "17Rnd_9x21_Mag";};
for "_i" from 1 to 2 do {_x addItemToVest "SmokeShell";};
for "_i" from 1 to 2 do {_x addItemToVest "HandGrenade";};
for "_i" from 1 to 8 do {_x addItemToVest "30Rnd_556x45_Stanag_red";};
