...
comment "Add weapons";
_x addWeapon "srifle_EBR_khk_F";
_x addPrimaryWeaponItem "muzzle_mzls_B";
_x addPrimaryWeaponItem "optic_DMS";
_x addPrimaryWeaponItem "20Rnd_762x51_Mag_blk_lxWS";
...
for "_i" from 1 to 5 do {
	_x addItemToVest "20Rnd_762x51_Mag_blk_lxWS";
};
...
for "_i" from 1 to 4 do {
	_x addItemToBackpack "20Rnd_762x51_Mag_blk_lxWS";
};
